...
let typeemail = 'Type email that is connected to your subscription:'
let yourlinkmessage = '✅ Here is your link. Tap on the button below to continue:'
let email_not_found = 'Your email is not found. Please type another email or buy subscription for it'
let renewsubscription = 'Your subscription will expire soon and you don\'t have auto payments enabled. Please renew your subscription to avoid kicking from the group\n\nExpire date: '
let youarekicked = 'Unfortunately, your subscription is expired. To continue using the group ' + group_name + ', you will need to renew your subscription'
let emailexists = 'This email is already attached to telegram account. Try another email'
let wrongemail = 'This is not an email. Try again: '
...
let messagefromadmin = '<b>You have new message from ' + group_name + '</b>'
let messagewassenttext = 'Your message was successfully sent to your clients'

let b_gotostart = ['◀️ Back', 'gotostartcb']
let b_typeemail = ['I\'ve already subscribed ▶️', 'enteremail_cb']
let b_requestlink = ['🔗 Get link', 'requestlink_cb']
let b_sendmessageadmin = ['✉️ Send Message', 'sendmessageadmin_cb']
...
bot.on('message', (msg) =>
{
    ...
    if (active_session[chat.id] !== undefined && !text.includes('/start')){
